...
#ifndef Kalkicoin_STAKEINPUT_H
#define Kalkicoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZKLC() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zKLCStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zklc, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZKLC() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZKLC() override { return false; }
};


#endif //Kalkicoin_STAKEINPUT_H
