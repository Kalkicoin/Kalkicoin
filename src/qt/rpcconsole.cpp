                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzKLCPathCustom = GetArg("-zklcbackuppath", "");
    ...
    if(!strzKLCPathCustom.empty()) {
        ui->wallet_customzklcbackuppath->setText(QString::fromStdString(strzKLCPathCustom));
        ui->wallet_customzklcbackuppath_label->setVisible(true);
        ui->wallet_customzklcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzKLCPathCustom.empty()) && nCustomBackupThreshold > 0) {
