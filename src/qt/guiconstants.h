...
/* Kalkicoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Kalkicoin"
#define QAPP_ORG_DOMAIN "kalkicoin.org"
#define QAPP_APP_NAME_DEFAULT "Kalkicoin-Qt"
#define QAPP_APP_NAME_TESTNET "Kalkicoin-Qt-testnet"
