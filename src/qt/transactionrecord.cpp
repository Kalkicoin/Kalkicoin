...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zklcTracker->HasMintTx(hash))) {
            //zKLC stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZKLC;
...
bool IsZKLCType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZKLC:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZKLC || type == TransactionRecord::MNReward) {
