...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Kalkicoin Core"),
     ...
     * override -datadir in the kalkicoin.conf file in the default data directory
     * (to be consistent with kalkicoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
