                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zKLC || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending KLC because you wouldn't check it anyway.
    if (context == Context::Send_KLC || context == Context::Send_zKLC) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR KLC</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                    ...
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("Kalkicoin will close now to finish the encryption process. "
                               ...
                               "your KLCs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
