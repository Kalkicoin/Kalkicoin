...
/**
 * Kalkicoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzklcseed(const UniValue& params, bool fHelp);
extern UniValue getzklcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzklc(const UniValue& params, bool fHelp);
extern UniValue dzklcstate(const UniValue& params, bool fHelp);
