...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Kalkicoin Core kalkicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kalkicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kalkicoin transaction") + "\n" +
                               "  kalkicoin-tx [options] -create [commands]   " + _("Create hex-encoded kalkicoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kalkicoin transaction
