...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Kalkicoin features */
        {"kalkicoin", "masternode", &masternode, true, true, false},
        {"kalkicoin", "listmasternodes", &listmasternodes, true, true, false},
        {"kalkicoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"kalkicoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"kalkicoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"kalkicoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"kalkicoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"kalkicoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"kalkicoin", "masternodedebug", &masternodedebug, true, true, false},
        {"kalkicoin", "startmasternode", &startmasternode, true, true, false},
        {"kalkicoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"kalkicoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"kalkicoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"kalkicoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"kalkicoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"kalkicoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"kalkicoin", "mnbudget", &mnbudget, true, true, false},
        {"kalkicoin", "preparebudget", &preparebudget, true, true, false},
        {"kalkicoin", "submitbudget", &submitbudget, true, true, false},
        {"kalkicoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"kalkicoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"kalkicoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"kalkicoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"kalkicoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"kalkicoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"kalkicoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"kalkicoin", "checkbudgets", &checkbudgets, true, true, false},
        {"kalkicoin", "mnsync", &mnsync, true, true, false},
        {"kalkicoin", "spork", &spork, true, true, false},
        {"kalkicoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzklcseed", &getzklcseed, false, false, true},
        {"zerocoin", "setzklcseed", &setzklcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzklc", &searchdzklc, false, false, true},
        {"zerocoin", "dzklcstate", &dzklcstate, false, false, true}
...
{
    return "> kalkicoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6133/\n";
}
