...
#   c) node1 mines 32 blocks, so now node 0 has 60001klc, node 1 has 4250klc, node2 has none.
#   d) node0 sends 601 klc to node2, in two transactions (301 klc, then 300 klc).
