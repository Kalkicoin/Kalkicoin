...
In order to support loading of multiple wallets in kalkicoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kalkicoin.cpp.
...
Changes to kalkicoin.cpp
----------------------
kalkicoin.cpp is the entry point into kalkicoin-qt, and as such, will require some minor modifications to provide hooks for
