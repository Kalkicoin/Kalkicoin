Contributing to Kalkicoin Core
============================

The Kalkicoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Kalkicoin Core project, and is not to be
confused with overall Kalkicoin Network Protocol consensus changes.

Whether a pull request is merged into Kalkicoin Core rests with the project merge
...
Patches that change Kalkicoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Kalkicoin consensus, it must have been
...
The project leader is the release manager for each Kalkicoin Core release.
